...
$string['chat:cancel_label'] = 'Cancel';
...
$string['chat:delete_conversation_title'] = 'Delete this conversation?';
...
$string['popup:cancel_confirm_btn'] = 'Stop showing';
$string['popup:cancel_dismiss_btn'] = 'Cancel';
$string['popup:cancel_title'] = 'Stop showing these resources?';
...
$string['privacy:metadata:astusse_gateway'] = 'In order to provide AI tutoring, ASTUSSE sends user identity and learning interactions to the external ASTUSSE AI gateway.';
$string['privacy:metadata:astusse_gateway:chatmessages'] = 'Chat messages typed by the user are sent to the AI service.';
$string['privacy:metadata:astusse_gateway:documentcontent'] = 'The content of documents and resources selected for ingestion is sent to the AI service.';
$string['privacy:metadata:astusse_gateway:email'] = 'The email address is sent to the AI service.';
$string['privacy:metadata:astusse_gateway:fullname'] = 'The first and last name are sent to the AI service.';
$string['privacy:metadata:astusse_gateway:quizanswers'] = 'Quiz answers submitted by the user are sent to the AI service.';
$string['privacy:metadata:astusse_gateway:roles'] = 'The user roles are sent to the AI service to adapt the response.';
$string['privacy:metadata:astusse_gateway:userid'] = 'The user ID is sent to identify the learner to the AI service.';
$string['privacy:metadata:astusse_gateway:username'] = 'The username is sent to the AI service.';
$string['privacy:metadata:local_astusse_consultation_queue'] = 'Resource-consultation events recorded before being sent asynchronously to the ASTUSSE AI service.';
$string['privacy:metadata:local_astusse_consultation_queue:cmid'] = 'The course-module ID of the consulted resource.';
$string['privacy:metadata:local_astusse_consultation_queue:courseid'] = 'The ID of the course the resource belongs to.';
$string['privacy:metadata:local_astusse_consultation_queue:status'] = 'The processing status of the consultation event.';
$string['privacy:metadata:local_astusse_consultation_queue:userid'] = 'The ID of the user who consulted the resource.';
$string['privacy:metadata:local_astusse_consultation_queue:viewedat'] = 'The time the resource was consulted.';
$string['privacy:metadata:local_astusse_course_ref_trainer'] = 'The reference trainer configured for each course.';
$string['privacy:metadata:local_astusse_course_ref_trainer:courseid'] = 'The ID of the course.';
$string['privacy:metadata:local_astusse_course_ref_trainer:timemodified'] = 'The time the reference trainer was last changed.';
$string['privacy:metadata:local_astusse_course_ref_trainer:trainerid'] = 'The ID of the user designated as reference trainer.';
$string['privacy:metadata:local_astusse_course_ref_trainer:updatedby'] = 'The ID of the user who set the reference trainer.';
$string['privacy:metadata:local_astusse_ingest_jobs'] = 'Asynchronous document-ingestion jobs queued by users to send course content to the ASTUSSE AI service.';
$string['privacy:metadata:local_astusse_ingest_jobs:courseid'] = 'The ID of the course the job originates from.';
$string['privacy:metadata:local_astusse_ingest_jobs:errormessage'] = 'Any error message returned while processing the job.';
$string['privacy:metadata:local_astusse_ingest_jobs:filename'] = 'The name of the file or resource being ingested.';
$string['privacy:metadata:local_astusse_ingest_jobs:status'] = 'The processing status of the ingestion job.';
$string['privacy:metadata:local_astusse_ingest_jobs:timecreated'] = 'The time the ingestion job was created.';
$string['privacy:metadata:local_astusse_ingest_jobs:userid'] = 'The ID of the user who queued the ingestion job.';
$string['privacy:metadata:preference:local_astusse_review_optout'] = 'Whether the user has opted out of the spaced-repetition pop-up.';
$string['privacy:metadata:preference:local_astusse_review_snooze_until'] = 'The time until which the spaced-repetition pop-up is snoozed for the user.';
$string['privacy:path:consultations'] = 'Resource consultations';
$string['privacy:path:ingestjobs'] = 'Ingestion jobs';
$string['privacy:path:referencetrainer'] = 'Reference trainer';
