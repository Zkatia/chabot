...
$string['chat:history_notice'] = 'History stays in your browser for this session.';
$string['chat:empty_state_detail'] = 'Course context is already sent to ASTUSSE. You can ask a free-form question or start from one of the suggested prompts.';
